...
<head>
<meta charset="UTF-8">
<title>회원가입_email</title>
<link rel="stylesheet" href="../css/reset.css">
<link rel="stylesheet" href="../css/design_join_email.css">
...
<body>
	<div id="join">
		...
		<form action="#" method="post" id="join_email_form">
				...
				<div class="bottom">
					<button type="button" class="btn btn-primary" id="next btn" style="width: 100px">인증코드 보내기</button>
				</div>
