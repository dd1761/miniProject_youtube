	...
	<header>
		<div class="channel-info">
			<div class="channel-logo">
				<img src="image/ytnheader.png" alt="Logo">
			</div>
		</div>
				...
				<div id='container'>
					<div id='box-left'>
						<div class="channel-profile">
							<img src="image/ytnprofile2.png" alt="Profile Picture">
						</div>
					</div>
					<div id='box-center'>
					...
					<div id='box-right'>
						<div class="subcribe">
							<img src="image/subcribe.png" alt="subcribe">
						</div>
					</div>
				</div>
				...
				<nav>
					<div class="navigation">
						...
						<div class="search-container">
							...
							<img src="image/search.png" id="search-icon" alt="검색"
								class="search-icon">
						</div>
					</div>
				</nav>
