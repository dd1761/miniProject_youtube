...
@keyframes checkmark {
  /* 체크박스가 체크된 상태일 때의 체크표시 애니메이션 효과 */
  0% {
    transform: scale(0); /* 0% 일때는 체크표시를 확대하지 않음 */
  }
  50% {
    transform: scale(1.2); /* 50% 일때는 체크표시를 1.2배 확대 */
  }
}
...
<body>
	...
	<!-- filter -->
	<div id="filter">
		<img src="image/filter.png" alt="필터"> <input type="text"
	...
	<div id="contents">
	<img src="image/noncontents2.png" alt="배경 이미지">
